 ...
 */
@Slf4j
public class DistributedDoubleBarrierSample2 {
    ...
    public static void main(String[] args) {
        try {
            ...
            log.info("{} 号barrier设置", DistributedDoubleBarrierSample2.class.getSimpleName());
            //等待所有分布式屏障节点到达屏障
            Thread.sleep(6000);
            barrier.enter();
            log.info("{} 启动...", DistributedDoubleBarrierSample2.class.getSimpleName());
            //等待所有分布式屏障节点到达屏障
            Thread.sleep(6000);
            barrier.leave();
            log.info( "退出..." );
